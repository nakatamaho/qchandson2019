...
plot '14_n2_631g_pes.data_' using 1:2 with linespoints lw 4 ps 1 title "FullCI",\
     '14_n2_631g_cc_mp_pes.data' using 1:2 with linespoints lw 4 ps 1 title "CCSD(T)",\
     '14_n2_631g_cc_mp_pes.data' using 1:3 with linespoints lw 4 ps 1 title "MP2", \
     '14_n2_631g_cc_mp_pes.data' using 1:4 with linespoints lw 4 ps 1 title "Hartree-Fock"
